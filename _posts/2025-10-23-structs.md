---
title: 'C++ Structs'
seo_title: 'Structs in C++'
seo_description: 'A simple breakdown of C++ structs. Covers the minimum as well as some advanced cases.'
date: 2025-10-23
...
`/` operator to join `PosixPath` objects or strings together. That said, I am open
to the criticisms of operator overloading and understand it can be controversial, here
are a couple links if you are interested in reading more
[The Cafes](https://cafe.elharo.com/programming/operator-overloading-considered-harmful/),
[Medium](https://medium.com/@fmmarzoa/say-no-to-operator-overloading-7b21aa06c518),
[Low LevelTv](https://www.youtube.com/shorts/p87yXC2pRwA). 
